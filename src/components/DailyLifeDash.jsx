      ...
      {view === "month" ? (() => {
        ...
        return (
          <>
            ...
            <p style={{ fontSize: 11.5, color: C.faint, textAlign: "center", margin: "6px 4px 0" }}>Grün = Protein-Ziel erreicht. Orange = Protein knapp verfehlt oder Kalorien &gt;120%. Rot = Protein stark verfehlt (&lt;70%) oder Kalorien massiv drüber (&gt;140%).</p>
          </>
        );
      })() : (
      <>
